...
class AppStyles {
  ...
  static final TextStyle body1 = TextStyle(
      fontFamily: 'Jost', fontSize: 14.sp, fontWeight: FontWeight.w400);
  static final TextStyle body2 = TextStyle(
      fontFamily: 'Jost', fontSize: 12.sp, fontWeight: FontWeight.w400);
  ...
  static final TextStyle header1 = TextStyle(
      fontFamily: 'Jost', fontSize: 18.sp, fontWeight: FontWeight.w600);
  static final TextStyle header2 = TextStyle(
      fontFamily: 'Jost', fontSize: 16.sp, fontWeight: FontWeight.w500);
  static final TextStyle header3 = TextStyle(
      fontFamily: 'Jost', fontSize: 14.sp, fontWeight: FontWeight.w500);
  static const TextStyle header4 =
      TextStyle(fontFamily: 'Jost', fontSize: 26, fontWeight: FontWeight.w600);
  ...
  static const TextStyle bodyGrey2 = TextStyle(
      fontFamily: 'Jost',
      fontSize: 16,
      fontWeight: FontWeight.w400,
      color: AppColors.grey142144150_1);
  static const TextStyle bodyGrey3 = TextStyle(
      fontFamily: 'Jost',
      fontSize: 18,
      fontWeight: FontWeight.w400,
      color: AppColors.grey142144150_1);
